        ...
        <form onSubmit={handleChangePassword} className="flex flex-col gap-3">
          {passwordSuccess && (
            <div role="alert" className="alert alert-success">
              ...
              <span className="font-body text-sm">Password updated successfully.</span>
            </div>
          )}
          {passwordError && (
          ...
          <div className="flex flex-col gap-1">
            <label className="font-body text-sm text-base-content/60">Confirm Password</label>
            <label className="input flex items-center gap-2 bg-background w-full max-w-sm p-3 border border-base-200 rounded-lg focus-within:border-base-content/30">
              <svg className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor">
                  <path d="M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h.172a2 2 0 0 0 1.414-.586l.814-.814a6.5 6.5 0 1 0-4-4z"></path>
            ...
            <p className="font-body text-xs text-base-content/40 mt-1">Must be 8+ characters with uppercase and number</p>
          </div>
